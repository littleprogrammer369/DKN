  ...
  return (
    <div className="flex flex-col px-1">
      <div className="text-center mb-6 mt-4">
        ...
        <h1 className="text-xl font-extrabold text-gray-800">{userName ? userName + ' عزیز،' : ''} به داده کشت نوین خوش آمدی!</h1>
        <p className="text-sm text-gray-500 mt-2">بیا اولین مزرعه‌ات رو بسازیم</p>
      </div>
      {step === 1 ? (<>
        <div className="card">
          <label className="text-xs font-bold text-gray-600 mb-1 block">اسم مزرعه *</label>
        ...
        <div className="card">
          <label className="text-xs font-bold text-gray-600 mb-1 block">شهر / استان</label>
          <input placeholder="مثلاً: ساوه، مرکزی" value={city} onChange={e => setCity(e.target.value)} className="input-glass text-right" />
        </div>
        <div className="card">
          <label className="text-xs font-bold text-gray-600 mb-1 block">مساحت (هکتار)</label>
